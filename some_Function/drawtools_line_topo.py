...
class Ui_Form(QWidget):
    ...
    def __init__(self,layerdata:singlelayer):
        ...
        self.all_information = draw_information_line_topo(self.layersdata)
        self.setfunction()
    ...
    def setfunction(self):
        self.lineEdit.setText(self.layersdata.xlabel)
        self.lineEdit_2.setText(self.layersdata.ylabel)
        if self.comboBox_4.currentIndex() ==0:
            self.lineEdit_3.setText(str(np.min(self.layersdata.new_y)))
            self.lineEdit_4.setText(str(np.max(self.layersdata.new_y)))

        else:
            self.lineEdit_3.setText(str(np.min(self.layersdata.new_x)))
            self.lineEdit_4.setText(str(np.max(self.layersdata.new_x)))


        self.all_information.append_scale_information('Horizontal','Range','minus',np.min(self.layersdata.new_x))
        self.all_information.append_scale_information('Horizontal','Range','maxus',np.max(self.layersdata.new_x))
        self.all_information.append_scale_information('Vertical','Range','minus',np.min(self.layersdata.new_y))
        self.all_information.append_scale_information('Vertical','Range','maxus',np.max(self.layersdata.new_y))


        self.comboBox_5.setCurrentText('By Counts')

        self.lineEdit_5.setText(str(5))
        self.lineEdit_6.setText(str(1))
        self.doubleSpinBox_6.setValue(2.00)
        self.doubleSpinBox_3.setValue(8.00)
        self.doubleSpinBox_2.setValue(1.50)
        self.doubleSpinBox_4.setValue(5)
        self.doubleSpinBox_5.setValue(1.50)
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(_translate("Form", "drawtools"))
